...
Iris is sort of the 'Hello World' of data science. I like to use it when trying out new languages and tools. 

## The Data  

The Iris dataset contains 50 observations each of the length and width of the petals and sepals of three species of irises (150 total sample size). I like to include a picture because until I encountered this set 'sepal' was not part of my personal vocabulary.
